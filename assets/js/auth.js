...
async function vrnSearchProfiles(filters = {}) {
  ...
  let query = sb.from("profiles")
    .select("id, ref_code, gender, age, height, country, city, county, consider_pakistan, had_previous, previous_type, has_children, immigration_status, qualifications, employment, country_looking_in, preference_line")
    .neq("id", me.id);
