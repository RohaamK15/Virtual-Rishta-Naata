...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const { data, error } = await admin
      .from("profiles")
      .select("id, ref_code, gender, age, city, county, country, country_looking_in, contact_email, subscription_status, profile_status, is_comped, is_promo_comped, is_admin, plan, created_at, push_platform")
